...
train_ann_file = 'stf/bt1/train_lbs'
train_data_prefix = 'stf/bt1/train_ims'

val_ann_file = 'stf/bt1/valid_lbs'
val_data_prefix = 'stf/bt1/valid_ims'

test_data_prefix = 'stf/bt1/test_ims'
